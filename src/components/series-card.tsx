...
export interface SeriesCardProps {
  ...
  startYear: number;
  endYear?: number; // Optional for ongoing series
  seasons: number;
  creator: string;
}
  ...
  return (
    <CardContainer className="inter-var">
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
        ...
        {/* Anos, Temporadas e Criador */}
        <CardItem
          translateZ="40"
          className="text-sm text-neutral-500 dark:text-neutral-300"
        >
          {yearRange} • {seasons} {seasons === 1 ? 'temporada' : 'temporadas'} • {creator}
        </CardItem>
        ...
        {/* Informações extras (Rating e status da série) */}
